...
int main(void) {
	...
	ParseAnim("assets/scripts/animation/spaceManWalk.anim");
	ParseAnim("assets/scripts/animation/enemyWalk.anim");
	ParseAnim("assets/scripts/animation/spaceManBoil.anim");
	ParseAnim("assets/scripts/animation/test.anim");
	return 0;
}
